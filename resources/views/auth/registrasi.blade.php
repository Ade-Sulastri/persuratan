                ...
                <form action="{{ route('registrasi') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="nip" name="nip"
                            ...
                            placeholder="Masukkan NIP" value="{{ $errors->has('nip') ? '' : old('nip') }}" oninput="this.value = this.value.slice(0, 18);" required>
                        @error('nip')
                    ...
                    <div>
                        ...
                        <input type="number" id="kode_satker" name="kode_satker" minlength="16" maxlength="16"
                            class="mt-1 w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
